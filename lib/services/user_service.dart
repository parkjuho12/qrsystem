...
class UserService {
  ...
  /// - message: 에러 메시지 (실패 시)
  static Future<Map<String, dynamic>> getUserProfile(String employeeNumber) async {
    try {
      ...
      if (response.statusCode == 200 && data['status'] == 'success') {
        ...
        return {
          'success': false,
          'message': data['message'] ?? '프로필 조회 실패',
        };
      }
    } catch (e) {
      return {
  ...
  static Future<Map<String, dynamic>> getUserProfiles(List<String> employeeNumbers) async {
    try {
